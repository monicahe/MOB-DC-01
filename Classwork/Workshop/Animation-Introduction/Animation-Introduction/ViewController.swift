...
//        self.view.layer.backgroundColor = UIColor.redColor().CGColor
        ...
        */
        ...
        newLabel.layer.shadowOffset = CGSizeMake(0, 2)
...
//        let path = UIBezierPath(arcCenter: self.createRandomPointOnScreen(), radius: CGFloat(16.0), startAngle: CGFloat(M_PI), endAngle: CGFloat(-M_PI / 2), clockwise: true)
        ...
        let path = UIBezierPath(arcCenter: self.createRandomPointOnScreen(), radius: 30, startAngle: CGFloat(M_PI / 2), endAngle: CGFloat(-M_PI), clockwise: false)
    ...
    @IBAction func createGradient(sender: AnyObject) {
        ...
        */
        ...
        gradient.colors = [UIColor.redColor().CGColor, UIColor.yellowColor().CGColor, UIColor.redColor().CGColor]
